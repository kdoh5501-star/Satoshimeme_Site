                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="text-center p-3 bg-transparent rounded-lg transform scale-120">
                      <p className="text-sm font-bold text-green-400 mb-1">$624.0K / $800K</p>
                      <p className="text-gray-300 text-xs font-bold">USDT RAISED</p>
                    </div>
                    <div className="text-center p-3 bg-transparent rounded-lg transform scale-120">
                      <p className="text-sm font-bold text-blue-400 mb-1">7.80B / 10.0B</p>
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <span className="font-bold text-xs text-white px-2 py-0.5 rounded-full" style={{fontFamily: 'Montserrat, sans-serif'}}>78.0%</span>
                    </div>
                  </div>
