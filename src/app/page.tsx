                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="text-center p-3 bg-transparent rounded-lg transform scale-120">
                      <p className="text-sm font-bold text-green-400 mb-1">$600.9K / $800K</p>
                      <p className="text-gray-300 text-xs font-bold">USDT RAISED</p>
                    </div>
                    <div className="text-center p-3 bg-transparent rounded-lg transform scale-120">
                      <p className="text-sm font-bold text-blue-400 mb-1">7.51B / 10.0B</p>
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <span className="font-bold text-xs text-white px-2 py-0.5 rounded-full" style={{fontFamily: 'Montserrat, sans-serif'}}>75.1%</span>
                    </div>
                  </div>
                    ...
                    <div className="mb-4">
                      <div className="grid grid-cols-2 gap-3 mb-4">
                        <div className="text-center p-3 bg-transparent rounded-[0px] transform scale-120">
                          <p className="text-sm font-bold text-green-400 2xl:text-[20px] mb-1" style={{fontFamily: 'Montserrat, sans-serif'}}>$600.9K / $800K</p>
                          <p className="text-gray-300 text-xs font-bold" style={{fontFamily: 'Montserrat, sans-serif'}}>USDT RAISED</p>
                        </div>
                        <div className="text-center p-3 bg-transparent rounded-lg transform scale-120">
                          <p className="text-sm font-bold mb-1 2xl:text-[20px] text-[#FACC15]" style={{fontFamily: 'Montserrat, sans-serif'}}>7.51B / 10.0B</p>
                      ...
                      <div className="relative">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <span className="font-bold text-xs text-white px-2 py-0.5 rounded-full 2xl:text-[15px]" style={{fontFamily: 'Montserrat, sans-serif'}}>75.1%</span>
                        </div>
